...
def test_database():
    ...
    try:
        ...
        # Проверяем админов
        cursor.execute('SELECT telegram_id, name, is_admin FROM users WHERE is_admin = true')
